...
public enum DefaultSunSpecModel implements SunSpecModel {
	...
	public static enum S101 implements SunSpecPoint {
		...
		V_AR(new ScaledValuePoint("S101_V_AR", "VAr", //
				"AC Reactive Power", //
				ValuePoint.Type.INT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE,
				"VAr_SF")), //
		...
		WH(new ScaledValuePoint("S101_WH", "WattHours", //
				"AC Energy", //
				ValuePoint.Type.ACC32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS,
				"WH_SF")), //
	...
	public static enum S120 implements SunSpecPoint {
		...
		V_AR_RTG_Q1(new ScaledValuePoint("S120_V_AR_RTG_Q1", "VArRtgQ1", //
				...
				ValuePoint.Type.INT16, true /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE,
				"VArRtg_SF")), //
		...
		W_H_RTG(new ScaledValuePoint("S120_W_H_RTG", "WHRtg", //
				...
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS,
				"WHRtg_SF")), //
	...
	public static enum S121 implements SunSpecPoint {
		...
		V_AR_MAX_Q1(new ScaledValuePoint("S121_V_AR_MAX_Q1", "VArMaxQ1", //
				...
				ValuePoint.Type.INT16, false /* mandatory? */, AccessMode.READ_WRITE, Unit.VOLT_AMPERE_REACTIVE,
				"VArMax_SF")), //
	...
	public static enum S122 implements SunSpecPoint {
		...
		W_AVAL(new ScaledValuePoint("S122_W_AVAL", "WAval", //
				...
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE,
				"WAval_SF")), //
		...
		ST_SET_LIM_MSK(new BitFieldPoint("S122_ST_SET_LIM_MSK", "StSetLimMsk", //
				...
				BitFieldPoint.Type.BITFIELD32, false /* mandatory? */, AccessMode.READ_ONLY,
	...
	public static enum S124 implements SunSpecPoint {
		...
		W_CHA_GRA(new ScaledValuePoint("S124_W_CHA_GRA", "WChaGra", //
				...
				ValuePoint.Type.UINT16, true /* mandatory? */, AccessMode.READ_WRITE, Unit.PERCENT,
				"WChaDisChaGra_SF")), //
		...
		STOR_CTL_MOD(new BitFieldPoint("S124_STOR_CTL_MOD", "StorCtl_Mod", //
				...
				BitFieldPoint.Type.BITFIELD16, true /* mandatory? */, AccessMode.READ_WRITE,
				S124_StorCtl_Mod.values())), //
		V_A_CHA_MAX(new ScaledValuePoint("S124_V_A_CHA_MAX", "VAChaMax", //
				"Setpoint for maximum charging VA.", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_WRITE, Unit.VOLT_AMPERE,
				"VAChaMax_SF")), //
		...
		STOR_AVAL(new ScaledValuePoint("S124_STOR_AVAL", "StorAval", //
				...
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.AMPERE_HOURS,
				"StorAval_SF")), //
	...
	public static enum S160_Evt implements SunSpecBitPoint {
	    GROUND_FAULT(new BitPoint(0, "S160_EVT_GROUND_FAULT", "Ground Fault", Level.INFO)), //
	    INPUT_OVER_VOLTAGE(new BitPoint(1, "S160_EVT_INPUT_OVER_VOLTAGE", "Input Over Voltage", Level.INFO)), //
	    RESERVED_2(new BitPoint(2, "S160_EVT_RESERVED_2", "Reserved 2")), //
	    DC_DISCONNECT(new BitPoint(3, "S160_EVT_DC_DISCONNECT", "DC Disconnect", Level.INFO)), //
	    RESERVED_4(new BitPoint(4, "S160_EVT_RESERVED_4", "Reserved 4")), //
	    CABINET_OPEN(new BitPoint(5, "S160_EVT_CABINET_OPEN", "Cabinet Open", Level.INFO)), //
	    MANUAL_SHUTDOWN(new BitPoint(6, "S160_EVT_MANUAL_SHUTDOWN", "Manual Shutdown", Level.INFO)), //
	    OVER_TEMP(new BitPoint(7, "S160_EVT_OVER_TEMP", "Over Temperature", Level.INFO)), //
	    ...
	    BLOWN_FUSE(new BitPoint(12, "S160_EVT_BLOWN_FUSE", "Blown Fuse", Level.INFO)), //
	    UNDER_TEMP(new BitPoint(13, "S160_EVT_UNDER_TEMP", "Under Temperature", Level.INFO)), //
	    MEMORY_LOSS(new BitPoint(14, "S160_EVT_MEMORY_LOSS", "Memory Loss", Level.INFO)), //
	    ARC_DETECTION(new BitPoint(15, "S160_EVT_ARC_DETECTION", "Arc Detection", Level.INFO)), //
	    ...
	    TEST_FAILED(new BitPoint(20, "S160_EVT_TEST_FAILED", "Test Failed", Level.INFO)), //
	    INPUT_UNDER_VOLTAGE(new BitPoint(21, "S160_EVT_INPUT_UNDER_VOLTAGE", "Input Under Voltage", Level.INFO)), //
	    INPUT_OVER_CURRENT(new BitPoint(22, "S160_EVT_INPUT_OVER_CURRENT", "Input Over Current", Level.INFO)); //
	...
	public static enum S160_OpStates implements OptionsEnum {
	    UNDEFINED(-1, "Undefined"), //
	    OFF(1, "Off"), //
	    SLEEPING(2, "Sleeping"), //
	    STARTING(3, "Starting"), //
	    ...
	    private S160_OpStates(int value, String name) {
	        this.value = value;
	        this.name = name;
	    }
	...
	public static enum S160 implements SunSpecPoint {
		DCA_S_F(new ScaleFactorPoint("S160_DCA_S_F", "Dca_SF", //
				"DC current scale factor")), //
		DCV_S_F(new ScaleFactorPoint("S160_DCV_S_F", "Dcv_SF", //
				"DC voltage scale factor")), //
		DCW_S_F(new ScaleFactorPoint("S160_DCW_S_F", "Dcw_SF", //
				"DC power scale factor")),//
		DCWH_S_F(new ScaleFactorPoint("S160_DCWH_S_F", "Dcwh_SF", //
				"DC energy scale factor")), //
		Evt(new ValuePoint("S160_EVT", "Evt", //
				"Global Events", //
				ValuePoint.Type.UINT32, true , AccessMode.READ_ONLY, Unit.NONE)), //				
		N(new ValuePoint("S160_N", "N", //
				"Number of Modules", //
				ValuePoint.Type.UINT16, false , AccessMode.READ_ONLY, Unit.NONE)), //
		TmsPer(new ValuePoint("S160_TMS_PER", "Tmsper", //
				"TmsPer", //
				ValuePoint.Type.UINT16, false , AccessMode.READ_ONLY, Unit.NONE)), //
		
		// 	Module 1
		MODULE_1_I_D(new ValuePoint("S160_MODULE_1_I_D", "Module1Id", //
				"Module1Id", //
				ValuePoint.Type.UINT16, false , AccessMode.READ_ONLY, Unit.NONE)), //
		MODULE_1_I_D_STR(new ValuePoint("S160_MODULE_1_I_D_STR", "Module1IdStr", //
				"Module1IdStr", //
				ValuePoint.Type.STRING8, false , AccessMode.READ_ONLY, Unit.NONE)), //

		MODULE_1_DCA(new ScaledValuePoint("S160_MODULE_1_DCA", "Module1Dca", //
				"Module1Dca", //
				ValuePoint.Type.UINT16, false , AccessMode.READ_ONLY, Unit.AMPERE, "Dca_SF")), //

		MODULE_1_DCV(new ScaledValuePoint("S160_MODULE_1_DCV", "Module1Dcv", //
				"Module1Dcv", //
				ValuePoint.Type.UINT16, false , AccessMode.READ_ONLY, Unit.VOLT, "Dcv_SF")), //
		MODULE_1_DCW(new ScaledValuePoint("S160_MODULE_1_DCW", "Module1DcW", //
				"Module1Dcw", //
		...
		MODULE_1_TEMP(new ValuePoint("S160_MODULE_1_TEMP", "Module1Temp", //
				"Module1Temp", //
				ValuePoint.Type.UINT16, false , AccessMode.READ_ONLY, Unit.DEGREE_CELSIUS)), //	
		
		
		MODULE_1_OP_STATES(new EnumPoint("S160_MODULE_1_OP_STATES", "Module1OPStates", //
				"Module1OPStates", //
				EnumPoint.Type.ENUM16, false , AccessMode.READ_ONLY, S160_OpStates.values())), //			

		MODULE_1_EVENTS(new ValuePoint("S160_MODULE_1_EVENTS", "Module1Events", //
				"Module1Events", //
				ValuePoint.Type.UINT32, false , AccessMode.READ_ONLY,Unit.NONE)), //	
				
		// Module 2
		MODULE_2_I_D(new ValuePoint("S160_MODULE_2_I_D", "Module2Id", //
		        "Module2Id", //
		        ValuePoint.Type.UINT16, false , AccessMode.READ_ONLY, Unit.NONE)), //
		MODULE_2_I_D_STR(new ValuePoint("S160_MODULE_2_I_D_STR", "Module2IdStr", //
		        "Module2IdStr", //
		        ValuePoint.Type.STRING8, false , AccessMode.READ_ONLY, Unit.NONE)), //

		MODULE_2_DCA(new ScaledValuePoint("S160_MODULE_2_DCA", "Module2Dca", //
		        "Module2Dca", //
		        ValuePoint.Type.UINT16, false , AccessMode.READ_ONLY, Unit.AMPERE, "Dca_SF")), //

		MODULE_2_DCV(new ScaledValuePoint("S160_MODULE_2_DCV", "Module2Dcv", //
		        "Module2Dcv", //
		        ValuePoint.Type.UINT16, false , AccessMode.READ_ONLY, Unit.VOLT, "Dcv_SF")), //
		MODULE_2_DCW(new ScaledValuePoint("S160_MODULE_2_DCW", "Module2DcW", //
		        "Module2Dcw", //
		        ValuePoint.Type.UINT16, false , AccessMode.READ_ONLY, Unit.WATT, "Dcw_SF")), //
		...
		MODULE_2_TMS(new ValuePoint("S160_MODULE_2_TMS", "Module2Tms", //
		        "Module2Tms", //
		        ValuePoint.Type.UINT32, false , AccessMode.READ_ONLY, Unit.SECONDS)), //
		MODULE_2_TEMP(new ValuePoint("S160_MODULE_2_TEMP", "Module2Temp", //
		        "Module2Temp", //
		        ValuePoint.Type.UINT16, false , AccessMode.READ_ONLY, Unit.DEGREE_CELSIUS)), //
		
		
		MODULE_2_OP_STATES(new EnumPoint("S160_MODULE_2_OP_STATES", "Module2OPStates", //
				"Module2OPStates", //
				EnumPoint.Type.ENUM16, false , AccessMode.READ_ONLY, S160_OpStates.values())), //			

		MODULE_2_EVENTS(new ValuePoint("S160_MODULE_2_EVENTS", "Module2Events", //
				"Module2Events", //
				ValuePoint.Type.UINT32, false , AccessMode.READ_ONLY,Unit.NONE)), //	
	...
	public static enum S201 implements SunSpecPoint {
		A(new ScaledValuePoint("S201_A", "Amps", //
				"Total AC Current", //
				ValuePoint.Type.INT16, true ,AccessMode.READ_ONLY, Unit.AMPERE, "A_SF")), //
		...
		TOT_WH_EXP_PH_A(new ScaledValuePoint("S201_TOT_WH_EXP_PH_A", "Total Watt-hours Exported phase A", "", //
				ValuePoint.Type.ACC32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS,
				"TotWh_SF")), //
		...
		TOT_V_AH_EXP(new ScaledValuePoint("S201_TOT_V_AH_EXP", "Total VA-hours Exported", //
				...
				ValuePoint.Type.ACC32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_HOURS,
				"TotVAh_SF")), //
		...
		TOT_V_ARH_IMP_Q1(new ScaledValuePoint("S201_TOT_V_ARH_IMP_Q1", "Total VAR-hours Imported Q1", //
				...
				ValuePoint.Type.ACC32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS,
				"TotVArh_SF")), //
		TOT_V_ARH_IMP_Q1_PH_A(
				new ScaledValuePoint("S201_TOT_V_ARH_IMP_Q1_PH_A", "Total VAr-hours Imported Q1 phase A", "", //
						ValuePoint.Type.ACC32, false /* mandatory? */, AccessMode.READ_ONLY,
						Unit.VOLT_AMPERE_REACTIVE_HOURS, "TotVArh_SF")), //
	...
	public static enum S701 implements SunSpecPoint {
		...
		TOT_WH_INJ(new ScaledValuePoint("S701_TOT_WH_INJ", "Total Energy Injected", //
				...
				ValuePoint.Type.UINT64, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS,
				"TotWh_SF")), //
		...
		TOT_VARH_INJ(new ScaledValuePoint("S701_TOT_VARH_INJ", "Total Reactive Energy Inj", //
				...
				ValuePoint.Type.UINT64, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS,
				"TotVarh_SF")), //
	...
	public static enum S702 implements SunSpecPoint {
		...
		INT_ISLAND_CAT_RTG(new BitFieldPoint("S702_INT_ISLAND_CAT_RTG", "Intentional Island Categories", //
				...
				BitFieldPoint.Type.BITFIELD16, false /* mandatory? */, AccessMode.READ_ONLY,
		...
		VAR_MAX_INJ(new ScaledValuePoint("S702_VAR_MAX_INJ", "Reactive Power Injected Setting", //
				...
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_WRITE, Unit.VOLT_AMPERE_REACTIVE,
				"Var_SF")), //
		...
		INT_ISLAND_CAT(new BitFieldPoint("S702_INT_ISLAND_CAT", "Intentional Island Categories", //
				"Intentional island categories.", //
				BitFieldPoint.Type.BITFIELD16, false /* mandatory? */, AccessMode.READ_WRITE,
	...
	public static enum S704 implements SunSpecPoint {
		...
		VAR_SET(new ScaledValuePoint("S704_VAR_SET", "Reactive Power Setpoint (Vars)", //
				...
				ValuePoint.Type.INT32, false /* mandatory? */, AccessMode.READ_WRITE, Unit.VOLT_AMPERE_REACTIVE,
				"VarSet_SF")), //
	...
	public static enum S802 implements SunSpecPoint {
		...
		W_H_RTG(new ScaledValuePoint("S802_W_H_RTG", "Nameplate Energy Capacity", //
				...
				ValuePoint.Type.UINT16, true /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS,
				"WHRtg_SF")), //
	...
	public static enum S64112 implements SunSpecPoint {
		...
		C_C_CONFIG_M_P_P_T_MODE(new EnumPoint("S64112_C_C_CONFIG_M_P_P_T_MODE", "MPPT mode", "", //
				EnumPoint.Type.ENUM16, true /* mandatory? */, AccessMode.READ_ONLY,
		...
		C_C_CONFIG_DATA_LOG_DAILY_K_W_H(new ScaledValuePoint("S64112_C_C_CONFIG_DATA_LOG_DAILY_K_W_H",
				"Data Log Daily (kWh)", "", //
				ValuePoint.Type.UINT16, true /* mandatory? */, AccessMode.READ_ONLY, Unit.KILOWATT_HOURS, "KWH_SF")), //
