...
@interface Config {
	...
	@AttributeDefinition(name = "SunSpec 160 Start Address", description = "Start address for SunSpec160 (individual DC string informations). Leave  0 for none. Default 40264 for Symo")
