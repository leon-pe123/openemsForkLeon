...
public interface Opendtu extends SinglePhaseMeter, ElectricityMeter, OpenemsComponent, EventHandler {
	...
	public static ModbusSlaveNatureTable getModbusSlaveNatureTableWithoutIndividualPhases(AccessMode accessMode) {
		return ModbusSlaveNatureTable.of(Opendtu.class, accessMode, 200) //
				.channel(6, ChannelId.RELATIVE_LIMIT, ModbusType.FLOAT32) //
				.channel(8, ChannelId.ABSOLUTE_LIMIT, ModbusType.FLOAT32) //
				.channel(10, ChannelId.MAX_ACTUAL_POWER, ModbusType.FLOAT32) //
				.build();
	}
}
